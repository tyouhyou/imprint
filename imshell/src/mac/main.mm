// Framework-mode thin main (code-contract §11): the AppKit host loop
// lives in run_mac.mm; a library consumer calls zb::shell::run from
// their own main (OBJCXX enabled) instead of this executable.
#include <iostream>
